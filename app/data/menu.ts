...
export const menuItems: MenuItem[] = [
  ...
  { type: 'Milk Tea Classic', name: 'Roasted Oolong Milk Tea', price: { R: '$5.60', L: '$6.10' }, description: 'Our deeply roasted oolong tea blended with creamy, rich milk.', DF: false, CF: false, image: '/drinks/ROMT.png' },
  { type: 'Milk Tea Classic', name: 'Honey Jasmine Milk Tea', price: { R: '$5.60', L: '$6.10' }, description: 'Floral jasmine milk tea sweetened naturally with rich honey.', DF: false, CF: false, image: '/drinks/HJGMT.png' },
  { type: 'Milk Tea Classic', name: 'Royal Milk Tea', price: { R: '$5.60', L: '$6.10' }, description: 'Our premium house black tea blended with rich cream for a luxurious texture.', DF: false, CF: false, image: '/drinks/RoyalMT.png' },
  { type: 'Milk Tea Classic', name: 'Caramel Milk Tea', price: { R: '$5.60', L: '$6.10' }, description: 'Classic milk tea layered with deep, buttery caramel notes.', DF: false, CF: false, image: '/drinks/CMT.png' },
  { type: 'Milk Tea Classic', name: 'Jasmine Milk Tea', price: { R: '$5.60', L: '$6.10' }, description: 'A delicate, floral milk tea made from our premium jasmine green tea leaves.', DF: false, CF: false, image: '/drinks/JGMT.png' },
  { type: 'Milk Tea Classic', name: 'Thai Iced Tea', price: { R: '$5.60', L: '$6.10' }, description: 'Authentic, sweet, and spiced Thai tea topped with a float of cream.', DF: false, CF: false, image: '/drinks/TIT.png' },
  { type: 'Milk Tea Classic', name: 'Thai Green Milk Tea', price: { R: '$5.85', L: '$6.35' }, description: 'A floral, vibrant green tea variation of our classic sweet Thai iced tea.', DF: false, CF: false, image: '/drinks/TGMT.png' },
  ...
  { type: 'Coffee', name: 'Vietnamese Coffee (Iced)', price: { R: '$5.85', L: '$6.35' }, description: 'Strong, traditional slow-dripped robusta coffee mixed with sweetened condensed milk. (No Ice, +$3)', DF: false, CF: false, image: '/drinks/VIC.png' },
  ...
  { type: 'Boba Milk', name: 'Strawberry Boba Milk', price: { R: '$5.85', L: '$6.35' }, description: 'Creamy, caffeine-free milk mixed with sweet strawberry puree and boba.', DF: false, CF: true, image: '/drinks/SBM.png' },
  { type: 'Boba Milk', name: 'Matcha Boba Milk Tea', price: { R: '$5.85', L: '$6.35' }, description: 'Earthy matcha and creamy milk perfectly paired with our signature boba.', DF: false, CF: false, image: '/drinks/MBMT.png' },
  { type: 'Boba Milk', name: 'Brown Sugar Roasted Oolong Milk Tea', price: { R: '$5.70', L: '$6.20' }, description: 'Deeply roasted oolong milk tea enhanced with our warm brown sugar boba.', DF: false, CF: false, image: '/drinks/BSROMT.png' }
]

export const toppings: Topping[] = [
  { name: 'Mango Jelly', description: 'A chewy, gel-based topping infused with sweet tropical mango flavor.', image: '/toppings/MangoJelly.png' },
  { name: 'Lychee Jelly', description: 'Translucent, firm jelly bits with a delicate, floral grape-like sweetness.', image: '/toppings/LycheeJelly.png' },
  { name: 'Coffee Jelly', description: 'Robust and slightly bitter cubes made from real coffee to balance sweet milk teas.', image: '/toppings/CoffeeJelly.png' },
  { name: 'Grass Jelly', description: 'A traditional, herbal jelly with a mild minty undertone and a silky texture.', image: '/toppings/GrassJelly.png' },
  { name: 'Rainbow Jelly', description: 'Colorful, multi-flavored coconut strips that offer a firm and playful chew.', image: '/toppings/RainbowJelly.png' },
  { name: 'Aloe Vera', description: 'Refreshing, juicy cubes of real aloe plant that are light and naturally sweet.', image: '/toppings/AloeVera.png' },
  { name: 'Egg Pudding', description: 'A smooth, custard-like topping with a rich vanilla and caramelized sugar taste.', image: '/toppings/EggPudding.png' },
  { name: 'Sea Salt Cream', description: 'A thick, frothy milk foam layer with a savory saltiness that cuts through sweetness.', image: '/toppings/SeaCream.png' },
  { name: 'Creme Brulee', description: 'A decadent, creamy swirl inspired by the classic French dessert with hints of toasted sugar.', image: '/toppings/CremeBrulee.png' }
]
