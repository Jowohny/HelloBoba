  ...
  <div class="min-h-screen pt-32 md:pt-40 pb-24 px-4 md:px-6 relative z-10 overflow-hidden bg-[#f6f6f6]">
    ...
    <div class="fixed inset-0 w-full h-full z-0 pointer-events-none overflow-hidden flex flex-col justify-center">
      <div class="absolute inset-0 flex flex-col justify-center gap-16 opacity-[0.06] blur-[1.5px] scale-110 -rotate-[2deg]">
        ...
        <div class="text-2 flex whitespace-nowrap text-[15vw] lg:text-[12vw] font-black font-sans text-green-900 tracking-tighter uppercase">
      ...
      <svg class="absolute inset-0 w-full h-full opacity-50" viewBox="0 0 1440 800">
        ...
        <path class="path-4" d="M-100,600 C400,600 900,800 1100,500 C1300,200 900,100 900,400 C900,700 1300,700 1600,400" fill="none" stroke="#bef264" stroke-width="7" stroke-dasharray="30 30" stroke-linecap="round"/>
      </svg>
    </div>
    ...
    <div class="w-full md:w-[75vw] lg:w-[95vw] xl:max-w-7xl relative z-10 grid grid-cols-1 lg:grid-cols-2 mx-auto gap-8">
      ...
      <div class="location-card text-center lg:text-left bg-[#f6f6f6] p-4 md:p-6 shadow-xl border border-zinc-300/30 rounded-3xl opacity-0">
        <iframe 
          class="w-full h-64 md:h-[400px] border-2 border-black rounded-2xl" 
        ...
        <div class="flex flex-col md:flex-row justify-between mt-6 gap-6">
          <div>
            <div class="location1-tag rounded-full w-fit bg-green-300 border border-2 border-green-600/40 uppercase px-2 py-1 mb-3 font-sans tracking-wide text-xs md:text-sm leading-none font-extrabold opacity-0 mx-auto lg:mx-0">
              Location 01
            </div>
            <div ref="card1TextRef" class="flex flex-col">
              <p class="uppercase text-2xl md:text-3xl font-sans tracking-tight font-black">Garvey Avenue</p>
              ...
              <div class="opacity-0">
                <p class="text-black font-sans font-black text-sm md:text-md tracking-wide leading-tight">Monday-Thursday: <span class="text-zinc-600/80 font-bold">11:00AM-9:00PM</span></p>
                <p class="text-black font-sans font-black text-sm md:text-md tracking-wide leading-tight">Friday-Sunday: <span class="text-zinc-600/80 font-bold">11:00AM-10:00PM</span></p>
              </div>
            </div>
          </div>
      ...
      <div class="location-card text-center lg:text-left bg-[#f6f6f6] p-4 md:p-6 shadow-xl border border-zinc-300/30 rounded-3xl opacity-0">
        ...
        <div class="flex flex-col md:flex-row justify-between mt-6 gap-6">
          <div>
            <div class="location2-tag rounded-full w-fit bg-green-300 border border-2 border-green-600/40 uppercase px-2 py-1 mb-3 font-sans tracking-wide text-xs md:text-sm leading-none font-extrabold opacity-0 mx-auto lg:mx-0">
              Location 02
            </div>
            <div ref="card2TextRef" class="flex flex-col">
              <p class="uppercase text-2xl md:text-3xl font-sans tracking-tight font-black">Peck Road</p>
              <div class="my-2 opacity-0">
